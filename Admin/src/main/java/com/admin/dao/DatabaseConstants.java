...
public interface DatabaseConstants {
    ...
    public final String updatePatientDoctorQuery = "UPDATE booking SET doctor = ? WHERE patient = ? AND doctor = ? AND date = ?";
    ...
    public final String updateBooking = "UPDATE booking SET date = ? WHERE patient = ? AND doctor = ? AND date = ?";
    public final String removeBooking = "DELETE FROM booking WHERE patient = ? AND doctor = ? AND date = ?";
